...
uv run nl2sql index                           # construire l'index de recherche
uv run nl2sql search "how much did customer 6 consume"
uv run nl2sql run --mode baseline --n 50
uv run nl2sql run --mode hybrid --n 50 --top-k 10
...
def add_generation_args(parser: argparse.ArgumentParser) -> None:
    ...
    parser.add_argument("--top-k", type=int, default=10, help="tables retenues en mode hybrid")
